...
#파일 경로 직접 설정==============================================================
train_csv_files = train_csv_files['Raw_files']
predict_csv_files = predict_csv_files['Raw_files']
#학습 케이스 직접 설정=============================================================
...
count = 0
for loss_is, optim_is, dropout_rate, num_epochs, learning_rate, weight_decay, early_stop_accuracy, batch_size, activation_is, BN_use,hidden_dims_index in itertools.product(
    loss_is_values, optim_is_values, dropout_rates, num_epoch_values, learning_rates, weight_decay_values, early_stop_accuracies, batch_size_values, activation_list, BN_use_choice,hidden_dims_indexs
):
    count +=1
    Loss_small_change_count=0
    hidden_dim=hidden_dims_array[hidden_dims_index]

    print(f"<Rand_times:{count}> -- ")
