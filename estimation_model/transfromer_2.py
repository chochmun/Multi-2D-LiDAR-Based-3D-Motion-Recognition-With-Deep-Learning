...
from tensorflow.keras.layers import Conv1D, BatchNormalization, MaxPooling1D, LSTM, Dense, Dropout, Input,TimeDistributed
...
class CNNModel:
    ...
    def build_model(self, input_shape, output_shape):
        ...
        # Feedforward 레이어 (Position-wise Feedforward Network)
...
if __name__=="__main__":
    ...
    # 모델 학습
    rnn_model.train_and_evaluate_model(X_train, y_train, epochs=100,batch_size=128, model_name='transfromer_8.h5')

    # 모델을 사용해 최종 예측 및 평가
    rnn_model.predict_and_evaluate(X_test, y_test, model_path='transfromer_8.h5', label_mapping=label_mapping)