...
if __name__=="__main__":
    ...
    # 모델 학습
    rnn_model.train_and_evaluate_model(X_train, y_train, epochs=100,batch_size=128, model_name='cnn_transformer_static_mun300_to_mun100.h5')

    # 모델을 사용해 최종 예측 및 평가
    rnn_model.predict_and_evaluate(X_test, y_test, model_path='cnn_transformer_static_mun300_to_mun100.h5', label_mapping=label_mapping)