...
# Form implementation generated from reading ui file 'QT\ui\ConnectUnityWindow.ui'
#
...
class Ui_ConnectUnityWindow(object):
    def setupUi(self, ConnectUnityWindow):
        ...
        ConnectUnityWindow.resize(600, 300)
        ...
        self.Button_Connect.setGeometry(QtCore.QRect(110, 260, 91, 25))
        self.Button_Connect.setObjectName("Button_Connect")
        self.Button_start = QtWidgets.QPushButton(ConnectUnityWindow)
        self.Button_start.setGeometry(QtCore.QRect(220, 260, 91, 25))
        self.Button_start.setObjectName("Button_start")
        self.Button_stop = QtWidgets.QPushButton(ConnectUnityWindow)
        self.Button_stop.setGeometry(QtCore.QRect(330, 260, 91, 25))
